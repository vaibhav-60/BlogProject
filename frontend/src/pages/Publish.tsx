...
export const Publish = () => {
    ...
    return <div className="bg-zinc-500 min-h-screen">
        <Appbar />
        {/* Add a div with padding-top to push content below the fixed navbar */}
        <div className="pt-16"> {/* Adjust the pt-16 (padding-top) value as needed */}
            <div className="flex justify-center w-full pt-8"> 
                <div className="max-w-screen-lg w-full">
                    ...
                    }} type="submit" className="mt-4 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-orange-700 rounded-lg focus:ring-4 focus:ring-orange-200 dark:focus:ring-orange-900 hover:bg-orange-800">
                        Publish post
                    </button>
                </div>
            </div>
